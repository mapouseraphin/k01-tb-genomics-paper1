...
#   confirm_a_to_b            -- asymmetric: fraction of A's calls in B
#   confirm_b_to_a            -- asymmetric: fraction of B's calls in A
#   confirm_sym               -- 0.5 * (confirm_a_to_b + confirm_b_to_a);
#                                this is the per-pair symmetric confirmation
#                                rate that drives lex level 5 and the Pareto
#                                y-axis from 2026-05-05.
